...
export class JogoDaVelhaService {
  ...
  /**
   * Inicializa o jogo. Define exebição da tela inicial
   *
   * @return void
   */
  inicializar(): void {
  ...
  jogar(posX: number, posY: number): void {
    ...
    this._jogador = (this._jogador === this.X) ? this.O : this.X; //se o jogador for igual a X então coloco o O no ligar do X
  ...
  cpuJogar(): void {
    ...
    this.tabuleiro[jogada[0]][jogada[1]] = this._jogador;//faz a jogada
    this.numMovimentos++;
    this.vitoria = this.fimJogo(jogada[0], jogada[1], this.tabuleiro, this._jogador);//ve se a jogada que a cpu fez foi suficiente para vencer o jogo
    this._jogador = (this._jogador === this.X) ? this.O : this.X;//inverte o jogador
  }
  ...
  /**
   *Retorna a peça X deve ser exibida para a coordenada informada
   *
   *@param number posX
   *@param number posY
   *@return boolean
  ...
  /**
   *Retorna a peça O deve ser exibida para a coordenada informada
   *
   *@param number posX
   *@param number posY
   *@return boolean
  ...
  /**
   *Retorna se a marcação de vitótia deve ser exibida para a coordenada informada
   *
   *@param number posX
   *@param number posY
   *@return boolean
